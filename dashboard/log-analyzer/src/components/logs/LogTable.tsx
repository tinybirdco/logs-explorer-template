          ...
          <Table className="table-fixed w-full">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="w-24" onClick={() => onSort('level')}>
                  Level{renderSortIndicator('level')}
                </TableHead>
                <TableHead className="w-32" onClick={() => onSort('service')}>
                  Service{renderSortIndicator('service')}
                </TableHead>
                <TableHead className="w-24" onClick={() => onSort('request_method')}>
                ...
                <TableHead className="w-24" onClick={() => onSort('status_code')}>
            ...
            <TableBody>
              {logs?.map((log, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="w-32">{log.service}</TableCell>
                  <TableCell className="w-24">{log.request_method}</TableCell>
